...
public class UsuarioDAO {
	...
	public  void insertFuncioanrio(Funcionario func) {
        String sql = "INSERT INTO USUARIOS (NOME, CPF, TELEFONE, TIPO, SALARIO, MOTO_MODELO, MOTO_ANO, MOTO_PLACA)VALUES (?,?,?,?,?,?,?,?)";
    ...
    public  void insertCliente(Cliente cli) {
        ...
        try (Connection conexao = Conexao.getConnection();
            ...
            stmt.setFloat(5, 0);
            stmt.setString(6, cli.getMoto_modelo());
            stmt.setInt(7, cli.getMoto_Ano());
            stmt.setString(8, cli.getMoto_Placa());
    ...
    private Usuario returnObj(ResultSet rs) throws SQLException {
    	...
    	if(rs.getString(6)=="CLIENTE") {
    		...
    		cli.setMoto_Ano(rs.getInt(8));
    		cli.setMoto_modelo(rs.getString(7));
    		cli.setMoto_Placa(rs.getString(9));
    		return cli;
    		...
    		func.setTipo(rs.getString(5));
    		func.setSalario(rs.getFloat(6));
    		return func;
    	}
    }
