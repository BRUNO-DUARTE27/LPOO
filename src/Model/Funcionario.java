...
public class Funcionario extends Usuario {
	...
	public Funcionario(String nome, String cpf, String telefone, String tipo,float salario) {
		super(nome,cpf,telefone,tipo);
	...
	public String toString() {
		return "Funcionario [nome=" + nome + ", cpf=" + cpf + ", telefone=" + telefone + ", tipo="
